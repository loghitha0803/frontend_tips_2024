...
const rainy = 'rainy';
export { imageValue, sunny, snow, rainy, firstContainer, styleVisible, styleHidden, temperature, tempHourly, timerSecond, index, hourly, humidityValue, precipitationValue, hrsMin, second, dateClass, amImage, farenheitValue };
